...
class LoginModalMobile extends StatefulWidget {
  const LoginModalMobile({Key? key}) : super(key: key);

  @override
  State<LoginModalMobile> createState() => _LoginModalMobilerState();
}

class _LoginModalMobilerState extends State<LoginModalMobile> {
  final TextEditingController emailController = TextEditingController();
  final TextEditingController passwordController = TextEditingController();
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: PrimaryButton(
                        onTap: () async {
                          if (!EmailValidator.validate(emailController.text)) {
                            AppMethods.dangerToast(context,
